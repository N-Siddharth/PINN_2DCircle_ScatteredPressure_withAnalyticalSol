...
# class DenseResNet() is used from the open source code provided in one of the 
# lecture series by Dr. Ilias Bilionis. Copyright material of Dr. Bilionis' 
# group - ref: https://www.predictivesciencelab.org/

#_______________________ Begin class DenseResNet() _____________________________
...
class DenseResNet(nn.Module):
    ...
    """
    def __init__(self, dim_in=2, dim_out=1, num_resnet_blocks=2, 
...
#_______________________ End class DenseResNet() _____________________________
